...
scatter!(p_real, kk0, real.(ww) ./ norm_val, color=:grey, alpha=0.1, markersize=1.5, label="", markerstrokewidth=0)
scatter!(p_imag, kk0, imag.(ww) ./ norm_val, color=:grey, alpha=0.1, markersize=1.5, label="", markerstrokewidth=0)
