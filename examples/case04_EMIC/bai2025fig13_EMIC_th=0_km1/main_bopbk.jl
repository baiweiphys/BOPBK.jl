...
#
theta_deg = 1.0e-4  # in degree
theta_rad = theta_deg * pi / 180.0  # in radian

#
nk = 100
kk0 = range(1.0e-5, 0.08, nk)
...
kz_test = kval_test * sθ1    # z-component of the wavevector
...
ww = zeros(ComplexF64, nk, nw)    # Pre-allocation (avoids scope issues)
