...
function pbk_b1snl(
    ...
    S1 = funcS_pbk(n, kappax_val, lambda_val, sgm_val, 2.0, 0.0, 1.0, 2.0, EPS0)
    S7 = funcS_pbk(n, kappax_val, lambda_val, sgm_val, 2.0, 0.0, -1.0, 1.0, EPS0)
    S17 = (kappax_val + sgm_val + 1.0) / kappax_val * S1 - 2.0 * sgm_val * lambda_val * S7
