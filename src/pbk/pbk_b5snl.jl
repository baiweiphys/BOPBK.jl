...
function pbk_b5snl(
    ...
    S5 = funcS_pbk(n, kappax_val, lambda_val, sgm_val, 0.0, 2.0, 3.0, 2.0, EPS0)
    S9 = funcS_pbk(n, kappax_val, lambda_val, sgm_val, 0.0, 2.0, 1.0, 1.0, EPS0)
    S59 = (kappax_val + sgm_val + 1) / kappax_val * S5 - 2.0 * sgm_val * lambda_val * S9
