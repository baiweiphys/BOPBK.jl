"""
Description: Assembles the Mz_pbk block within the global PBK matrix. 
...
Optimized solver for PBK plasma (In-place).
Author: Bai Wei (baiweiphys@gmail.com, baiwei12@mail.ustc.edu.cn)
Created: 2025-12-06
Changelog:
2026-02-08: Optimized Mz_pbk block. 
"""
...
function Mz_pbk!(
    ...
    # Step 0
    @inline function idx_M_pbk(s::Int, idx_n::Int, l::Int, j::Int)
        SNLJ2oneDim(Ns_pbk, kappasz_pbk, s, idx_n, l, j)
    end
    ...
    # for z-dirction:
    # by20 = 1im*\epsilon_0*sum_{s}\omega_{ps}^2
